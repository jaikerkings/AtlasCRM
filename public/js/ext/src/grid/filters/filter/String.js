...
Ext.define('Ext.grid.filters.filter.String', {
     ...
     */
    emptyText: 'Introduzca texto para filtrar...',
    ...
    onInputKeyUp: function (field, e) {
        ...
        if (k === e.RETURN && field.isValid()) {
            //aca
            var mymenu = myGrid.headerCt.getMenu();
            var columnDataIndex = mymenu.activeHeader.dataIndex;
            filtrar_dos(columnDataIndex,field.getValue());
            //fin de aca
            e.stopEvent();
            me.menu.hide();
            return;
