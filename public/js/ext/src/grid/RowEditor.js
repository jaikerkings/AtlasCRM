...
Ext.define('Ext.grid.RowEditor', {
    ...
    //<locale>
    saveBtnText  : 'Aceptar', //Update
    //</locale>
    //<locale>
    cancelBtnText: 'Cancelar', //Cancel
    //</locale>
    //<locale>
    errorsText: 'Errores', //Errors
    //</locale>
    //<locale>
    dirtyText: 'Necesitas aceptar o cancelar para tomar los cambios', //You need to commit or cancel your changes
    //</locale>
    ...
    cancelEdit: function() {
        ...
        //Aca llame al modelo para el eliminar el actual registro no llenado completo
        var sm = grid.getSelectionModel();
        if (nuevoUsuario) {
         storeUsuario.remove(sm.getSelection());
         nuevoUsuario = false;
        }
    },
    ...
    completeEdit: function() {
        ...
        me.hide();
        //Aca debo llamar grabarUsuario en BD
        grabarUsuario();
        nuevoUsuario = false;
        return true;
    },
